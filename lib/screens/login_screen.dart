...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submit(String lang) async {
    ...
    if (result.success) {
      ...
      _showSnack(
        msg,
        result.isNewUser ? Colors.blue.shade700 : Colors.green.shade700,
      );
                ...
                child: Center(
                  child: SingleChildScrollView(
                    padding: EdgeInsets.symmetric(
                      horizontal: context.responsive.spacing20,
                    ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      '🎓 ',
                                      style: TextStyle(
                                        fontSize: responsive.fontSizeSubtitle,
                                      ),
                                    ),
                                    Text(
